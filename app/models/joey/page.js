          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-muted text-sm leading-relaxed mb-12 text-reveal">
                The Joey offers an unparalleled blend of performance and comfort, setting a new standard in aviation. Precision engineering and lightweight carbon fiber make the Joey incredibly agile. For larger parties or extended ranges, explore the <a href="/models/boon" className="text-gold hover:text-white transition-colors underline decoration-gold/30 hover:decoration-white">4-seater Boon</a>, or <a href="/contact" className="text-gold hover:text-white transition-colors underline decoration-gold/30 hover:decoration-white">contact our team</a> for customized build options. This aircraft guarantees exceptional fuel efficiency without compromising on power. The pilot experience is truly transformative, featuring intuitive controls and unmatched visibility. With impressive cross country capability and a premium luxury finish down to the finest detail, the Joey is crafted for those who demand excellence in every flight.
              </p>
